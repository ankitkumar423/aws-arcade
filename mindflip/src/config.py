...
# Text size settings
TEXT_SIZE_SMALL = 0.8
TEXT_SIZE_MEDIUM = 1.0  # Default
TEXT_SIZE_LARGE = 1.2

# Combo system settings
COMBO_BONUS_MULTIPLIER = 0.5  # 50% bonus per consecutive match
MAX_COMBO_MULTIPLIER = 3.0    # Maximum 3x bonus
...
GAME_RULES = [
    ...
    "9. Consecutive matches build combo bonus"
]
...
POINTS_SYSTEM = [
    ...
    "• Combo bonus: Up to 3x for consecutive matches",
